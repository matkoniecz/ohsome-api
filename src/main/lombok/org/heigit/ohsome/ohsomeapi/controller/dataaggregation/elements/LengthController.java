...
public class LengthController {
  ...
  public Response length(HttpServletRequest servletRequest, HttpServletResponse servletResponse)
      throws Exception {
    ElementsRequestExecutor executor = new ElementsRequestExecutor(RequestResource.LENGTH,
  ...
  public Response lengthDensity(HttpServletRequest servletRequest,
    ...
    ElementsRequestExecutor executor =
        new ElementsRequestExecutor(RequestResource.LENGTH, servletRequest, servletResponse, true);
    return executor.aggregate();
  }
